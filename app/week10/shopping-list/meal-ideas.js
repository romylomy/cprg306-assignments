      ...
      <div className='  md:p-10    '>
        ...
        {ingredient == null ? (
          ...
          <div>
            ...
            <div className='py-4 space-y-2 grid grid-cols-1 lg:w-1/2'>
                {mealList.map(meal => (
                <button className='font-semibold on bg-sky-100 hover:border-2 border-sky-700 rounded-lg' key={meal.idMeal}>{meal.strMeal}</button>
                ))}
