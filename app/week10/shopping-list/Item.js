...
export default function Item({ key, name, icon, quantity, category, setIngredient }) {
  ...
  return (
    <button onClick={handleItemClick} className=" relative font-mono hover:bg-orange-400 hover:bg-blur-lg  shadow-sm rounded-lg text-slate-700 bg-slate-300 bg-opacity-50 hover:scale-105 ease-in-out duration-300">
        <div className="p-4">
