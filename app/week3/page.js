...
export default function Page() { // Use PascalCase for the component name.
  ...
  return (
    <section className='p-5 md:px-10 lg:px-60'>
      <div className="p-10 shadow-lg bg-gray-600 bg-opacity-50 rounded-xl">
        <div className=' p-4 rounded-lg my-10 flex align-center justify-center  '>
        ...
        <div className='grid gap-2 grid-cols-1 md:grid-cols-2'>
          ...
          <div className='  bg-opacity-10 rounded-lg p-5 '>
