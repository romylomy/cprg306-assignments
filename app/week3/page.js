...
export default function Page() { // Use PascalCase for the component name.
  ...
  return (
    <main className=' bg-slate-100 p-5 md:px-10 lg:px-60'>
      <div className="p-10  ">
        <div className='backdrop-blur-md bg-orange-50 bg-opacity-40  p-4 shadow-lg rounded-lg my-10 flex align-center justify-center  '>
        ...
        <div className='grid gap- grid-cols-1 md:grid-cols-2'>
          ...
          <div className=' shadow-lg backdrop-blur-md bg-orange-50 bg-opacity-40  rounded-lg p-5 '>
